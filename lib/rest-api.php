...
function gutenberg_filter_post_query_arguments( $prepared_args, $request ) {
	if ( is_post_type_hierarchical( $prepared_args['post_type'] ) || $prepared_args['post_type'] === 'wp_block' ) {
